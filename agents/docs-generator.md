...
3. **Analyze Architecture**
   ...
   - Identify deployment targets (Cloudflare Pages/Workers, Vercel, etc.)
...
[Include wrangler.toml settings, Vercel config, or other deployment info]

---
*This file was auto-generated by ci-standards plugin. Update by re-running the docs-generator agent.*
```
...
---
*Generated by ci-standards plugin docs-generator agent*
